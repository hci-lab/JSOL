var Area, Axes, Background, Canvas_Geometry, Canvas_Parse, Diamond, Line, Picture, Point, Text, Tooltip,Bar,StackedBar,Pie,Arc,Guides,Image
...
for (l = 0, len = obj.length; l < len; l++) {
  ...
  return results;
    ...
    if (i.type === "x") {
        minX = i.min;
        maxX = i.max;}
    if(minY < minX){minG = minY;}else {minG = minX;}
    if(maxY > maxX){maxG = maxY;}else {maxG = maxX;}
